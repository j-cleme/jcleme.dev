...
<div
	class="bg-black/60 my-8 md:my-auto fill-purple-600 h-20 px-4 rounded-xl w-3/4 mx-auto flex flex-row gap-8 justify-center items-center md:w-max md:flex-col md:h-72 md:absolute md:right-40 md:top-20"
>
	<a
		href="mailto:jcleme@proton.me"
		class="hidden group p-2 max-h-max max-w-max bg-pink-600 rounded-md text-white transition-all duration-200 hover:shadow-lg hover:text-black hover:scale-105 hover:-translate-y-2 md:flex flex-row gap-2"
		><Send />
	</a>
	<a
		...
		rel="noreferrer"
		title="LinkedIn"
		class="h-10 w-10 hover:fill-fuchsia-400 transition-all duration-200 hover:scale-105 hover:-translate-y-2"
	>
	...
	<a
		...
		rel="noreferrer"
		title="ProtonMail"
		class="h-10 w-10 hover:fill-fuchsia-400 transition-all duration-200 hover:scale-105 hover:-translate-y-2 after:'' after:w-full"
		on:click={() => {
